...
def show_menu():
    ...
    while menu_active:
        ...
        create_button('Basic Images', (screen_width - button_width) // 2, start_y + button_height + gap, button_width, button_height, (100, 100, 100), (150, 150, 150), show_basic_images)
